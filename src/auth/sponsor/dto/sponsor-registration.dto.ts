...
export class SponsorRegistrationDto {
  @ApiProperty({
    ...
    example: 'Nepal Investment Bank Ltd.',
    minLength: 2,
    maxLength: 100
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Years of establishment',
    example: 2001,
  })
  ...
  @ApiProperty({
    ...
    example: 'Durbar Marg, Kathmandu Metropolitan City, Kathmandu',
    minLength: 10,
    maxLength: 200
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Sectors that the company works in',
    example: [Sector.TECHNOLOGY, Sector.HEALTH],
    enum: Sector,
    isArray: true,
    type: [String]
  })
  ...
  @ApiPropertyOptional({
    description: 'Additional work sectors not listed in predefined options',
  ...
  @ApiProperty({
    description: 'Sectors that the company is interested in sponsoring',
    example: [Sector.EDUCATION, Sector.ENVIRONMENT],
    enum: Sector,
    isArray: true,
    type: [String]
  })
  ...
  @ApiPropertyOptional({
    description: 'Additional sponsorship sectors not listed in predefined options',
    example: 'Sports Development',
    maxLength: 100
  })
  @IsOptional()
  @IsString()
